...
export class StoresController {
    ...
    async getFeaturedStores(req: Request, res: Response) {
        try {
            ...
            const result = await storesService.getFeaturedStores(pagination, lat as string, lng as string, type as string | undefined);
            return sendResponse(
                res,
                200,
                true,
                'Featured stores fetched successfully',
                formatPaginatedResponse(result.data, result.totalCount, pagination.page, pagination.limit)
            );
        } catch (error: any) {
            return sendResponse(res, 500, false, error.message);
    ...
    async getStoresByCity(req: AuthRequest, res: Response) {
        try {
            ...
            return sendResponse(
                ...
                200,
                true,
                'Stores in your city fetched successfully',
                formatPaginatedResponse(result.data, result.totalCount, pagination.page, pagination.limit)
            );
        } catch (error: any) {
            return sendResponse(res, 500, false, error.message);
